        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            <div class='col-md-4'>
                    <div class='panel panel-info'>
                        <div class='panel-body'> <img src='product_images/$pro_image' style= 'height:220px;' />
                        <div class='product-name'>$pro_title</div>
                        <div class='price'>£$pro_price.00</div>
...
if(isset($_POST["addProduct"])){
    if (isset($_SESSION["uid"])) {
       ...
       <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
       <b>Please Sign in to add to cart :)</b>
       </div>   
       ";
    }
...
if($run_quey) {
    ...
    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Cart Updated</b>
    </div>
    ";
}
}
